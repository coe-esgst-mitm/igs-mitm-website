...
export default function UpcomingEvent() {
  return (
    <section
      id="events"
      className="bg-[#fffdf9] px-4 py-12 sm:px-8 lg:py-16"
    >
      <div className="mx-auto max-w-[1250px]">
        ...
        <div className="overflow-hidden rounded-2xl border border-[#dfd1c1] bg-[#f5efe6] shadow-xl">
          ...
          <div className="grid lg:grid-cols-[0.82fr_1.18fr]">
            ...
            <div className="bg-[#e8ded1] p-5 sm:p-7">

              <p className="mb-4 text-center text-xs font-bold uppercase tracking-[0.18em] text-[#713717]">
                FDP Brochure
              </p>
              ...
              <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-1">
                ...
                <div className="relative overflow-hidden rounded-lg bg-white shadow-md">
                  ...
                  <Image
                    src="/images/fdp-poster-2.jpg"
                    alt="FDP Brochure - Sheet 2"
                    width={1200}
                    height={1600}
                    className="h-auto w-full object-contain"
                  />
              ...
              <div className="mt-6 text-center">
                ...
                <a
                  href="/images/FDP-Brochure.pdf"
                  download
                  className="inline-flex items-center justify-center gap-2 rounded-md bg-[#713717] px-6 py-3 text-sm font-bold uppercase tracking-wide text-white shadow-md transition hover:bg-[#582b16]"
                >
                  <span>↓</span>
                  Download Brochure
                </a>

                <p className="mt-2 text-xs text-[#76685d]">
                  Download the complete FDP brochure in PDF format
                </p>
            ...
            <div className="flex flex-col justify-center px-6 py-9 sm:px-10 lg:px-12">
              ...
              <div className="mt-7 flex flex-wrap gap-3">
                ...
                <a
                  href="/fdp"
                  className="inline-flex items-center justify-center rounded-md bg-[#713717] px-6 py-3.5 text-sm font-bold uppercase tracking-wide text-white shadow-md transition hover:bg-[#582b16]"
                >
                  Explore FDP
